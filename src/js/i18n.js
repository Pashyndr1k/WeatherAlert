...
(function () {
  ...
  const EN = {
    ...
    layout_title: 'WIDGET LAYOUT', layout_strip: 'Bottom strip (map-first)', layout_side: 'Right panel (two columns) — default', layout_hint: 'Drag any widget to reorder; the order is kept in both layouts.',
  ...
  const UK = {
    ...
    layout_title: 'РОЗКЛАДКА ВІДЖЕТІВ', layout_strip: 'Нижня смуга (карта на весь екран)', layout_side: 'Права панель (два стовпці) — типово', layout_hint: 'Перетягуйте віджети, щоб змінити порядок; він зберігається в обох розкладках.',
